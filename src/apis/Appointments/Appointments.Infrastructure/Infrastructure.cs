...
public sealed class AppointmentRepository(IDbConnectionFactory factory) : IAppointmentRepository
{
    ...
    public async Task<Guid?> GetPatientIdForSubjectAsync(Guid tenantId, string subjectId, CancellationToken cancellationToken)
    {
        const string sql = """
            SELECT patient_id
        ...
        return await connection.ExecuteScalarAsync<Guid?>(
            new CommandDefinition(sql, new { TenantId = tenantId, SubjectId = subjectId }, cancellationToken: cancellationToken));
    }
    ...
    public async Task<IReadOnlyCollection<Appointment>> ListForProfessionalAsync(
        Guid tenantId,
        Guid professionalId,
        DateTimeOffset fromUtc,
        DateTimeOffset toUtc,
    ...
    public async Task<IReadOnlyCollection<Appointment>> ListForPatientAsync(
        Guid tenantId,
        Guid patientId,
        DateTimeOffset fromUtc,
        DateTimeOffset toUtc,
